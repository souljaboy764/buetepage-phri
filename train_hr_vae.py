...
if __name__=='__main__':
	...
	parser.add_argument('--src', type=str, default='./data/orig_hr/vae_data.npz', metavar='RES',
						help='Path to read training and testing data (default: ./data/orig_hr/vae_data.npz).')
